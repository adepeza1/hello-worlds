...
<sql:setDataSource var = "db" driver = "oracle.jdbc.OracleDriver"
 ...
 <sql:query var = "result" dataSource = "${db}" >
            SELECT team_id, teamnames, coachname
            FROM teams
         </sql:query>
	<!-- Top Bar -->
	<div class="w3-bar  w3-theme w3-large w3-margin-top ">
		...
		<span class="w3-bar-item w3-text-theme-d2 w3-right">Some
			Product App</span> <span class="w3-bar-item w3-text-theme-d2 w3-left"></span>
	</div>
	<!-- End of Top Bar -->
			...
			<div class="w3-twothird" style="margin-left: 300px;">
				...
				<div class="container" style="margin-top: 35px">
					<div class="form-group pull-right">
						<input type="text" id="formSearch" name="formSearch"
							class="search form-control" placeholder="Search forms..." />
					</div>
					<table class="w3-table-all w3-hoverable w3-card" id="forms_table"
