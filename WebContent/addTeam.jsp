...
<div class="container">
  ...
  <form action="" method="post">
    <!-- <div class="form-group">
      <label for="number">Team ID:</label>
      <input type="number" class="form-control" id="teamid" placeholder="Enter team ID" name="teamId">
    </div> -->
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="text">Coach Name</label>
      <input type="text" class="form-control" id="coach" placeholder="Enter coachs name" name="coachname">
    </div>
...
<%
response.sendRedirect("addTeam");

}%>
<script type="text/javascript" src="scripts/validateTeam.js"></script>
</body>
</html>
